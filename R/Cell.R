...
cell<-methods::setClass(Class = 'cell',
                        slots = c(name = 'character',
                                  centroid ='list',
                                  cytoplasm = 'simpleShape',
                                  nucleus = 'simpleShape',
                                  organelle = 'simpleShape',
                                  markers = 'list'),
                        prototype = list( name = 'aNameForThisCell',
                                          centroid = list(),
                                          cytoplasm = new('simpleShape'),
                                          nucleus = new('simpleShape'),
                                          organelle = new('simpleShape'),
                                          markers = list()))
...
methods::setMethod(f = 'bh_create',
                   ...
                   definition = function(x,
                     ...
                     if (!is.null(x@cytoplasm)) {
                       ...
                       # cytoplasm<-list()
                       # cytoplasm$centroid<-sf::st_sfc(NULL)
                     ...
                     if (!is.null(x@nucleus)) {
                       ...
                       # nucleus<-list()
                       # nucleus$centroid<-sf::st_sfc(NULL)
                     ...
                     if (!is.null(x@organelle)) {
                       ...
                       # organelle<-list()
                       # organelle$centroid<-sf::st_sfc(NULL)
...
bh_defineCell<-function(name = NULL,
  ...
  if (is.null(name)) stop('provide a name for this cell')
